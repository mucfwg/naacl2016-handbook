...
\usepackage[colorlinks,
            pdftitle={When Annotation Schemes Change Rules Help:  A Configurable Approach to Coreference Resolution beyond OntoNotes}, 
            pdfauthor={Amir Zeldes ; Shuo Zhang},
            pdfsubject={CORBON 2016},
            %pdfkeywords={...}
...
\includepdfset{pages=-,clip,noautoscale,pagecommand={\thispagestyle{plain}}}\setcounter{page}{92}
\citeinfo{92}{101}
\includepdf[pages=1,]{final/9/9_Paper.pdf}
\ClearShipoutPicture
